...
def process_tasks(partner_settings):
    # Two levels of task group, one task group inside another task_group
    with TaskGroup(group_id="process_tasks") as process_tasks: # could be done with decorator too
